...
def chatbot(system_prompt: str, few_shot_key: str, task_name: str, init_obs: str, rule: str, valid_actions: List[str], ctx_len: int):
    ...
    # log_dir = f"logs_no_think_ctx_{ctx_len}_{task_name}"
    log_dir = f"logs_no_think_ctx_{ctx_len}"
    ...
    # Start
    alfworld_prompt_file = './MATRIX/MATRIX/alfworld_3prompts_no_json_all_loc_no_think.json'
